...
if base_model_name =='rbert':
    source_multimodal_data_full = np.load("../data/source_unimodal_out.npy")
    target_multimodal_data_full = np.load("../data/target_unimodal_out.npy")
...
print(classification_report(all_true_labels, all_predictions, target_names = ['fake', 'real'], digits=4))
# Converting to csv
