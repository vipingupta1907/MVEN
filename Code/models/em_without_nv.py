# -*- coding: utf-8 -*-
"""cross_validate_nv_em_ce.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Vhmdzfa9-B5RZ7y0jafwaXvcw5C_25YL
"""
...
epochs = 25
lr = 3e-5 # Less LR
lr =0.007 #0.0062 96% accuracy #0.0065 83.39% accuracy   #0.007 75.46% accuracy #0.005,0.006 99% accuracy        # 0.008 73.75% accuracy
...
class FinalClassifier(nn.Module):
    ...
    def forward(self, target_input, source_input, emotion_input):
       ...
       # emotion_reprs = emotion_input
        combine_n_e = emotion_input      ######torch.cat((novelty_reprs, emotion_reprs), 1) # 640
